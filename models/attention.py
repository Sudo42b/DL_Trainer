...
class Attention(nn.Module):
    ...
    def __init__(self, block_num, class_num=100, channel_size=3):
...
def attention56(args):
    return Attention([1, 1, 1], class_num=args.nc, channel_size=args.cs)

def attention92(args):
    return Attention([1, 2, 3], class_num=args.nc, channel_size=args.cs)
