...
class EntryFlow(nn.Module):
    ...
    def __init__(self, channel_size=3):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(channel_size, 32, 3, padding=1, bias=False),
            nn.BatchNorm2d(32),
...
class Xception(nn.Module):
    ...
    def __init__(self, block, num_class=100, channel_size= 3):
        super().__init__()
        self.entry_flow = EntryFlow(channel_size)
...
def xception(args):
    return Xception(MiddleFLowBlock, num_class=args.nc, channel_size = args.cs)
