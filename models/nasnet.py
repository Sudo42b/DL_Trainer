...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, num_classes=1001, stem_filters=96, penultimate_filters=4032, filters_multiplier=2, channels=3):
...
def nasnetalarge(args, pretrained=False):
    ...
    if pretrained:
        ...
        model = NASNetALarge(num_classes=args.nc, channels=args.cs)
    return model
