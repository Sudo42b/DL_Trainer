...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384, class_nums=100, channel_size=3):

        super().__init__()
        self.stem = Inception_Stem(channel_size)
...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, A, B, C, k=256, l=256, m=384, n=384, class_nums=100, channel_size=3):
        super().__init__()
        self.stem = Inception_Stem(channel_size)
...
def inceptionv4(args):
    return InceptionV4(4, 7, 3, class_nums=args.nc, channel_size=args.cs)

def inception_resnet_v2(args):
    return InceptionResNetV2(5, 10, 5, class_nums=args.nc, channel_size=args.cs)
