...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=100, groups=3, channel_size=3):
        super().__init__()
        ...
        self.conv1 = BasicConv2d(channel_size, out_channels[0], 3, padding=1, stride=1)
...
def shufflenet(args):
    return ShuffleNet([4, 8, 4], num_classes=args.nc, channel_size=args.cs)
