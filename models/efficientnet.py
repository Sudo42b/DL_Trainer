...
class EfficientNet(nn.Module):
    ...
    def __init__(self, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2, channels=3):
        ...
        # stem convolution
        self.stem_conv = _Conv3x3Bn(channels, stem_channels, 2)
...
def efficientnet_b0(args):
    ...
    param[2] = args.sz
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
def efficientnet_b1(args):
    param = net_param['efficientnet-b1']
    param[2] = args.sz
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
def efficientnet_b2(args):
    param = net_param['efficientnet-b2']
    param[2] = args.sz
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
...
def efficientnet_b4(args):
    param[2] = args.sz
    param = net_param['efficientnet-b4']
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
def efficientnet_b5(args):
    param = net_param['efficientnet-b5']
    param[2] = args.sz
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
def efficientnet_b6(args):
    param = net_param['efficientnet-b6']
    param[2] = args.sz
    return EfficientNet(param, num_classes=args.nc, channels=args.cs)
def efficientnet_b7(args):
...
if __name__ == '__main__':
    ...
    flops, params = profile(model, inputs=(x_image,))
